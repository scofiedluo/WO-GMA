...
def plot_score(per_frame_scores, video_names, action_types, work_dir, experiment='test', epoch=1, type='CPGB_scores'):
    """
...
def plot_time_prediction(scores,labels,work_dir,experiment,threshold,state,precentage=0.2,kappa=8):
